 ...
 */
package ma.hps.powercard.compliance.serviceimpl.spec.ldap;
 ...
 * @since 3.1
 */
public final class SuffixAwareActiveDirectoryLdapAuthenticationProvider extends
	 ...
	 */
	public SuffixAwareActiveDirectoryLdapAuthenticationProvider(String domain, String url,
			String rootDn) {
